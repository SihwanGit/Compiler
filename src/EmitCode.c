...
{
	// emit an instruction with two integer operands (base, offset)
	fprintf(ucodeFile, "           ");
...
{
	// emit an instruction with three integer operands (p1, p2, p3)
	fprintf(ucodeFile, "           ");
...
{
	// emit a jump/call instruction with a label operand
	fprintf(ucodeFile, "           ");
